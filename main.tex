...
\CVSubHeadingListStart
  ...
  \CVSubheading{\textbf{Programming}}{}{}{}
    \CVItemListStart
    \vspace{-0.5cm}
      \CVItem{\textbf{High-Performance Computing:} CUDA, OpenMP, SIMD, profiling (Valgrind, pprof), Latency hiding}
      \CVItem{\textbf{Languages:} C++, Python (NumPy, SciPy, Pandas, Matplotlib), Rust, R, C\#}
      \CVItem{\textbf{Environments:} Linux, Bash, Conda/mamba, Docker, Slurm-managed clusters}
    \CVItemListEnd
