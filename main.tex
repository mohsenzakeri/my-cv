...
\section{Skills}
 \begin{itemize}[leftmargin=0.5cm, label={}]
    \small{\item{
    \textbf{Sequencing Technologies}{: Oxford Nanopore (ONT), PacBio, bulk and Single-cell RNA-seq, Single-nucleus RNA-seq, DNA-seq}
    }} \\
    \textbf{High Performance Computing}{: Valgrind}\\
