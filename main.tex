...
\begin{minipage}[c]{0.4\textwidth}
    ...
    \href{mailto:mzakeri1@jhu.edu}{\underline{mzakeri1@jhu.edu}}\\
...
%      {Institution you worked with}{unused}
    \CVSubheading
    {Efficient Nanopore read classification}{2022 - present}
    {Johns Hopkins University}\\
    {I have implemented \href{https://github.com/mohsenzakeri/marlin}{Marlin} which is
    a data structure based on Move-Structure for indexing pangenomes. Marlin computes
    matching statistics for Nanopore reads very quickly in order to be classified. $|$ \emph{\small{C++}}}
