...
\begin{itemize}
  \item \fullcite{wabi2025movi}
  \item \fullcite{Zakeri2024bds}
  \item \fullcite{zakeri2024recombseq}
  \item \fullcite{Zakeri2023informatics}
  \item \fullcite{Zakeri2023wemsa}
  %\nocite{Shivakumar2023Poster}
  \item \fullcite{Boots2022Poster}
  %\nocite{Sarkar2020}
  \item \fullcite{CedarPoster2019}
...
%      \CVItemListEnd
    \CVSubheading{Postdoctoral Fellow}{2022 - present}
      ...
      \CVItemListStart
        \CVItem{Involved in projects focused on design and development of efficient data structures for pangenomes and Oxford Nanopore read classification. $|$ \emph{\small{C++}}}
      \CVItemListEnd
    \CVSubheading
      {Computational Biologist Intern}{Summer 2021} %{Jun. 2021 -- Aug. 2021}
      {Ellumigen (formerly:  Ocean Genomics)}{Pittsburgh, PA}
      \CVItemListStart
...
\end{comment}
  ...
  \CVSubHeadingListStart
  \CVSubheading
  {Conference Session Chair} {August 2025}
  {WABI Conference on Algorithms in Bioinformatics at University of Maryland}{}
  \CVItemListStart
  \CVItem{Moderated presentations, leading discussion and \textsc{Q\&A}}
  \CVItemListEnd
  \CVSubheading
