...
\begin{minipage}[c]{0.4\textwidth}
    ...
    \href{https://www.mohsenzakeri.com}{\underline{mohsenzakeri.com}} \\
    \href{mailto:mohs.zakeri@gmail.com}{\underline{mohs.zakeri@gmail.com}} \\
...
%      \CVItemListEnd
    \CVSubheading{Postdoctoral Fellow}{2022 - present}
      ...
      \CVItemListEnd
    \CVSubheading
      {Computational Biologist}{2021} %{Jun. 2021 -- Aug. 2021}
...
%      {Institution you worked with}{unused}
    \CVSubheading
    {Efficient and scalable indexing of pangenomes}{2022 - present}
    %{Efficient Nanopore read classification}
    {Johns Hopkins University}\\
    {I have implemented \href{https://github.com/mohsenzakeri/movi}{Movi} which is
    a data structure based on Move-Structure for indexing pangenomes. Movi computes
    exact matching queries (pseudo-matching lengths) for short and long reads.
    The Pseudo-matching lengths computed by Movi is used for real-time classification of Nanopore reads. $|$ \emph{\small{C++}}}

    \CVSubheading
    {Efficient and accurate methods for single-cell RNA-seq analysis}{2020 - 2021}
      {University of Maryland}\\
      {I contributed to the design and development of a variation of pseudoalignment with structural constraints 
      (\href{https://github.com/COMBINE-lab/pufferfish/blob/develop/src/MemCollector.cpp#L586}{sketch mode}) 
      for mapping single-cell RNA-seq reads which is used with 
    ...
    \CVSubheading
      ...
      is an aligner based on the Pufferfish index which aligns different types of short reads including RNA-seq,
      DNA-seq and metagenomic reads to a collection of indices. I was involved in the main stages of the development and
      debugging for this tool. $|$ \emph{\small{C++}}}
    \CVSubheading
      {A pipeline for metagenomic abundance estimation}{2018}
      {Stony Brook University}\\
      {I contributed to the design and development of \href{https://github.com/COMBINE-lab/pufferfish/tree/AGAMEMNON}{Cedar} 
      which is a fast and accurate quantification method for short
      read metagenomic reads using lightweight alignment methods and optimization with Expected Maximization. $|$ \emph{\small{C++}}}
    \CVSubheading
      {Improving the accuracy of lightweight RNA-seq mapping methods}{2017 - 2019}
      {Stony Brook University}\\
      {I contributed to the development of the idea of \href{https://github.com/COMBINE-lab/RapMap/tree/selective-alignment}{Selective-alignment}
      for increasing the specificity and sensitivity of
      lightweight alignment methods which are used in fast RNA-seq quantification approaches. $|$ \emph{\small{C++}}}
    \CVSubheading
      {Improving the accuracy of fast RNA-seq quanfitication methods}{2016 - 2022}
      {Stony Brook University}\\
      {I modified the probablistic model of bulk RNA-seq in \href{https://github.com/COMBINE-lab/salmon}{Salmon}
      to increase the fidelity of the equivalence class-based \href{https://github.com/COMBINE-lab/salmon/tree/factorizations}{factorization}
      which led to an improvement of the accuracy of the estimations in challenging cases. $|$ \emph{\small{C++}}}
    % \CVSubheading
...
%      {School}{Where}
  \CVSubheading
  {Needle in a haystack: Finding the origin of shredded sequences (Instructor)}{Fall 2023}
  {Johns Hopkins University}{Balitmore, MD}

  \CVSubheading
  {Software Engineering in Bio-medical Research (Co-Instructor)}{Fall 2022}
  {Johns Hopkins University}{Balitmore, MD}
  ...
  \CVSubheading
      ...
      {Stony Brook University}{Stony Brook, NY}
    \CVSubheading
      {Analysis of Algorithms for graduate students (TA)}{2016}
      {Stony Brook University}{Stony Brook, NY}
    \CVSubheading
      {Advanced Programming, Artificial Intelligence (TA)}{Fall 2014 -- Spring 2015}
      {University of Tehran}{Tehran, Iran}
  \CVSubHeadingListEnd
