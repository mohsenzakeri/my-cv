...
\CVSubHeadingListStart
  \CVSubheading{\textbf{Programming}}{}{}{}
    \CVItemListStart
    \vspace{-0.5cm}
      \CVItem{\textbf{Languages:} C++, Python (NumPy, SciPy, Pandas, Matplotlib), Rust, R, C\#}
      \CVItem{\textbf{Environments:} Linux, Git/GitHub, Conda/mamba, Docker, Slurm-managed clusters, AWS}
      \CVItem{\textbf{Workflow Management:} Nextflow, Snakemake, Bash scripts}
      \CVItem{\textbf{High-Performance Computing:} CUDA, OpenMP, SIMD, Latency hiding, Profiling (Valgrind, pprof)}
    \CVItemListEnd
    \CVSubheading{\textbf{Bioinformatics}}{}{}{}
    \vspace{-0.5cm}
    \CVItemListStart
      \CVItem{\textbf{Tools:} SAMtools, Bowtie2, BWA/BWA-MEM, minimap2, IGV, Kraken2, Salmon, DESeq2}
      \CVItem{\textbf{Analysis:} Sequence Alignment/Mapping, Quantification, Metagenomics, RNA-seq (bulk \& single-cell/10x)}
      \CVItem{\textbf{Sequencing Technologies:} Illumina, 10x Genomics, Oxford Nanopore (ONT), PacBio}
    \CVItemListEnd
...
%      {Institution you worked with}{unused}
    \CVSubheading
      ...
      \CVItem{Designed a data structure which minimizes the number of cache misses per query. Minimized the latency of remaining cache misses by C++ prefetching.}
      \CVItemListEnd
...
%       \CVItemListEnd
    ...
    \CVSubheading
      ...
      \CVItem{Developed a probabilistic model to improve the EM-based bulk RNA-seq quantification \href{https://github.com/COMBINE-lab/salmon}{Salmon}
...
\begin{comment}
    ...
    sequence alignments - from genomic coordinates to transcriptomic coordinates. $|$ \emph{\small{Rust}}}
          ...
          \CVSubheading{Software Engineer Intern}{Summer 2018} %{Sep. 2017 -- Aug. 2018}
          {Cafe Bazaar}{Tehran, Iran}
          \CVItemListStart
            \CVItem{\href{https://cafebazaar.ir/?l=en}{Cafe Bazaar} is the largest Android app store for Iranian mobile applications.
            I participated in a summer internship program focused on web-based software development using the Django framework.
            I contributed to the development of a web-based application for crawling news stories 
            from various news websites and displaying them on a single web page. $|$ \emph{\small{Python and Django}}}        
...
% *: co-first authorship
% \begin{itemize}
% \item \fullcite{majidian2025evani}
% \item \fullcite{guccione2025incomplete}
% \item \fullcite{zakeri2024movi}
% \item \fullcite{shivakumar2024sigmoni}
% \item \fullcite{wu2023seesaw}
% \item \fullcite{he2022alevin}
% \item \fullcite{skoufos2022agamemnon}
% \item \fullcite{almodaresi2021puffaligner}
% \item \fullcite{srivastava2020alignment}
% \item \fullcite{sarkar2018towards}
% \item \fullcite{ismb2017factorization}
% \end{itemize}

% \section{Pre-prints}
% \begin{itemize}
%   \item \fullcite{brown2025kebab}
%   \item \fullcite{tan2025movi}
%   % \item \fullcite{depuydt2023r}
%   \item \fullcite{srivastava2021accounting}
%   \item \fullcite{zakeri2021likeforlike}
% \end{itemize}
