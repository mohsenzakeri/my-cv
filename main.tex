...
%      {Institution you worked with}{unused}
    \CVSubheading
      ...
      which scales very well for highly similar references while being very fast to query exact matches. $|$ \emph{\small{C++}}}
      \CVItemListEnd
    ...
    \CVSubheading
      ...
      {Postdoc fellow at Johns Hopkins University}{ }
      \CVItemListStart
      \CVItem{Designed and developed a method to compute exact matching queries (pseudo-matching lengths) with \href{https://github.com/mohsenzakeri/movi}{Movi}
      for real-time classification of Oxford Nanopore reads. $|$ \emph{\small{C++}}}
      \CVItem{Collaborated in the development of Sigmoni for multi-class classification of raw Nanopore signals. $|$ \emph{\small{C++}}}
      \CVItemListEnd
    \CVSubheading
...
sequence alignments - from genomic coordinates to transcriptomic coordinates. $|$ \emph{\small{Rust}}}
    ...
    \CVSubheading
      ...
      \CVItemListStart
      \CVItem{Contributed to the design and development of
    ...
    \CVSubheading
      ...
      \CVItemListStart
      \CVItem{Contributed to the design and development of \href{https://github.com/COMBINE-lab/pufferfish/tree/AGAMEMNON}{Cedar}, 
