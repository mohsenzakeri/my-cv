...
%      {Institution of Study}{Where it is located}
    \CVSubheading
      {{PhD $|$ \emph{\small{Computer Science, Advisor: Prof. Rob Patro}}}}{Aug. 2018 -- present}
      {University of Maryland}{College Park, MD}
    \CVSubheading
      {{MSc $|$ \emph{\small{Computer Science, Advisor: Prof. Rob Patro}}}}{Aug. 2015 -- May. 2017}
      {Stony Brook University}{Stony Brook, NY}
    \CVSubheading
      {{BSc $|$ \emph{\small{Computer Engineering, Major: Software Engineering}}}}{Sep. 2011 -- Jun. 2015}
...
%      \CVItemListEnd
    ...
    \CVSubheading
      {Computational Biologist}{Jun. 2021 -- Aug. 2021}
      {Ocean Genomics}{Pittsburgh, PA}
      \CVItemListStart
        \CVItem{Development of a software for converting a genome coordinated SAM file to a transcriptomic coordinated SAM file.}
      \CVItemListEnd
    \CVSubheading
      {Software Engineer}{Sep. 2017 -- Aug. 2018}
